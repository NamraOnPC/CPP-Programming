...
namespace AMA {
    ...
    class Product : public iProduct {
        ...
        private: 
            ...
            void Setter(const char* productSku, const char* nameOfProduct,const char* productUnit, int productQuantityOnHand, bool taxable, double priceBeforeTax, int productQuantityRequired);
        ...
        public:
            ...
            bool operator>(const iProduct& object) const;
